...
2. **Changed surfaces** — List files or areas touched (desktop UI, runtime protocol, Convex schema, etc.).
...
- Protocol or contract changes in `@h3code/agent-protocol`
- Runtime routing, provider registry, or connection lifecycle in `@h3code/agent-runtime-server`
