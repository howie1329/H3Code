...
export type PiProviderEvent =
  ...
  | { type: "message.streaming"; phase: "start" | "update" | "end"; message?: unknown; deltaType?: string; errorMessage?: string; occurredAt: number }
  | { type: "tool.updated"; phase: "start" | "update" | "end"; toolCallId: string; toolName: string; args?: unknown; content?: unknown; isError?: boolean; errorText?: string; occurredAt: number }
  | { type: "queue.updated"; steering: string[]; followUp: string[]; occurredAt: number }
  | { type: "compaction.updated"; phase: "start" | "end"; reason?: string; aborted?: boolean; willRetry?: boolean; errorMessage?: string; result?: unknown; occurredAt: number }
  | { type: "retry.updated"; phase: "start" | "end"; attempt?: number; maxAttempts?: number; delayMs?: number; success?: boolean; errorMessage?: string; occurredAt: number }
  ...
  | { type: "extension.notify"; message: string; notifyType: string; occurredAt: number }
