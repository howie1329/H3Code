import type { PiProviderEvent } from "./types.js";

export function mapPiSessionEvent(raw: unknown, occurredAt = Date.now()): PiProviderEvent[] {
...
function formatExtensionError(event: Record<string, unknown>) {
